...
export const metadata: Metadata = {
  title: "Espoltify | Terms and Conditions",
  description: "Espoltify Terms and Conditions",
};
  ...
  return (
    <main className="p-10">
      ...
      <TypographyP className="mb-6">
        Welcome to Espoltify, an open-source social media platform designed for
      ...
      <TypographyP className="mb-6">
        By creating an account or using Espoltify, you agree to these Terms and
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        <li>
          ...
          post. By posting, you grant Espoltify a worldwide, royalty-free
        ...
        <li>
          ...
          Espoltify reserves the right to remove content that violates these
          guidelines.
        </li>
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        ...
        <li>
          Interfere with the operation of Espoltify or disrupt other users&apos;
          experience.
        </li>
      </ul>
      ...
      <TypographyP className="mb-6">
        Espoltify reserves the right to suspend or terminate your account if you
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        <li>
          ...
          service, Espoltify does not guarantee continuous availability and may
          experience downtime.
        </li>
        ...
        <li>
          ...
          law, Espoltify disclaims liability for any indirect, incidental, or
      ...
      <TypographyP className="mb-6">
        Espoltify may update these Terms and Conditions periodically. Users will
      ...
      <TypographyP className="mb-6">
        Thank you for being part of the Espoltify community. We aim to provide a
